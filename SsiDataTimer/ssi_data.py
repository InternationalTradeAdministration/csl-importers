...
source_abbr = 'ssi'
source_name = 'Sectoral Sanctions Identifications List (SSI) - Treasury Department'
source_list_url = 'https://www.treasury.gov/ofac/downloads/consolidated/consolidated.xml'
source_information_url = 'https://home.treasury.gov/policy-issues/financial-sanctions/consolidated-sanctions-list-non-sdn-lists/sectoral-sanctions-identifications-ssi-list'
...
def main():
    ...
    for entry in root.findall('xmlns:sdnEntry', ns):
        ...
        if 'UKRAINE-EO13662' not in programs:
            continue
